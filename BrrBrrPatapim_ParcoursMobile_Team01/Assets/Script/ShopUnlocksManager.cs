...
namespace Script
{
    ...
    public class ShopUnlocksManager : MonoBehaviour
    {
        ...
        [Tooltip("Tous les textes o� afficher la quantit� d�or dans le jeu.")]
        ...
        //  Reset complet : or, unlocks, �quipements
        ...
        public void ResetAll()
        {
            ...
            Debug.Log(" Shop totalement r�initialis� (gold, unlocks, skins).");
        }
        ...
        //  Met � jour tous les textes de gold r�f�renc�s
        ...
        //  Permet d�enlever un texte si tu d�truis un objet � runtime
